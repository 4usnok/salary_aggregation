...
async def main_menu(message: types.Message):
    ...
    # Показываем список
    text = (
        "Добрый день! Я ваш личный помощник в просмотре информации о зарплатах сотрудников компании."
...
async def show_filter_options(message: types.Message):
    ...
    await message.answer("Выберите, как хотите отфильтровать:", reply_markup=keyboard)
